          ...
          <button
            ...
            title={
              isMissingRequiredWebsite
                ...
                : 'Search Google for this business’s Instagram page'
            }
            ...
            onClick={async (e) => {
              ...
              setIsSearching(true);
              try {
                const result = await dispatch(runLeadGoogleSearchResearchThunk('instagram'));
                if (!result.ok) {
                  if (result.error === 'website_required') {
                    ...
                    toast.error(result.message ?? 'Instagram search failed');
                  }
                  return;
                }
                ...
                if (result.leadUpdated) {
                  ...
                  toast.success('Search finished — no matching Instagram URL found');
                }
              } finally {
