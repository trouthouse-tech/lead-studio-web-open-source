...
import {
  deleteLeadContactEmailAttachmentThunk,
  getLeadContactEmailAttachmentsByEmailIdThunk,
...
export const EmailAttachmentInput = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      await dispatch(getLeadContactEmailAttachmentsByEmailIdThunk(currentEmail.id));
    };
    void load();
  ...
  const removeSaved = async (id: string) => {
    ...
    setDeleting(true);
    await dispatch(deleteLeadContactEmailAttachmentThunk(id));
    setDeleting(false);
  };
