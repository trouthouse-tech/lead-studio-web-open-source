...
**Local / trusted development** is the primary assumption for this open-source web app: you run Next and a compatible Express API (for example mentorai-server) on your machine or a controlled network. See the **“Local development and trust”** section in `README.md` for env vars, client vs server secrets, and where HTTP traffic is sent.
